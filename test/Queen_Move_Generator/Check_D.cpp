...
namespace Kangaroo::Queen_Move_Generation::Check_D {
...
*/
  Kangaroo::Chess_Board( std::array<Bitboard, 15>{
    ...
    /* white rooks    */ 0x0000002000000000, /* white queens  */ 0x0000000800000000, /* white king    */ 0x0000000000200000,
...
*/
  ...
  1    .  .  .  .  .  .  .  .
     ...
     */
    TEST(Queen_Move_Generation, Check_D) {
        ...
        Chess_Board board{};
        const auto status = board.reset_board("8/1q1p1p2/8/1rQ2R2/8/1P1P1K2/8/8 w KQkq - 0 1 ");
