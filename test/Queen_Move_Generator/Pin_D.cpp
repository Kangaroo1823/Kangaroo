...
namespace Kangaroo::Queen_Move_Generation::Pin_D {
...
*/
  Kangaroo::Chess_Board( std::array<Bitboard, 15>{
    /* white pawns    */ 0x00000000000a0000, /* white knights */ 0x0000000000000000, /* white bishops */ 0x0000000000000000,
    /* white rooks    */ 0x0000002000000000, /* white queens  */ 0x0000000010000000, /* white king    */ 0x0000000000200000,
    /* black pawns    */ 0x0028000000000000, /* black knights */ 0x0000000000000000, /* black bishops */ 0x0000000000000000,
    /* black rooks    */ 0x0000000200000000, /* black queens  */ 0x0002000000000000, /* black king    */ 0x0000000000000000,
...
*/
  Kangaroo::Chess_Board( std::array<Bitboard, 15>{
    /* white pawns    */ 0x00000000000a0000, /* white knights */ 0x0000000000000000, /* white bishops */ 0x0000000000000000,
    /* white rooks    */ 0x0000002000000000, /* white queens  */ 0x0000040000000000, /* white king    */ 0x0000000000200000,
    /* black pawns    */ 0x0028000000000000, /* black knights */ 0x0000000000000000, /* black bishops */ 0x0000000000000000,
    /* black rooks    */ 0x0000000200000000, /* black queens  */ 0x0002000000000000, /* black king    */ 0x0000000000000000,
    /* en passant sq. */ 0x0000000000000000, /* half move num */ 0x0000000000000000, /* full move num */ 0x0000000000000001 }),
/*
...
*/
  Kangaroo::Chess_Board( std::array<Bitboard, 15>{
    /* white pawns    */ 0x00000000000a0000, /* white knights */ 0x0000000000000000, /* white bishops */ 0x0000000000000000,
    /* white rooks    */ 0x0000002000000000, /* white queens  */ 0x0002000000000000, /* white king    */ 0x0000000000200000,
    /* black pawns    */ 0x0028000000000000, /* black knights */ 0x0000000000000000, /* black bishops */ 0x0000000000000000,
 ...
 /*
   ...
   1    .  .  .  .  .  .  .  .
     ...
     */
    TEST(Queen_Move_Generation, Pin_D) {
        ...
        Chess_Board board{};
        const auto status = board.reset_board("8/1q1p1p2/8/1r1Q1R2/8/1P1P1K2/8/8 w KQkq - 0 1 ");
