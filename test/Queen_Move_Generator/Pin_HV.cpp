...
namespace Kangaroo::Queen_Move_Generation::Pin_HV {
...
*/
        Kangaroo::Chess_Board(std::array<Bitboard, 15>{
            /* white pawns    */ 0x0000000000220000, /* white knights */ 0x0000000000000000, /* white bishops */
            0x0000000000000000,
            /* white rooks    */ 0x0000002000000000, /* white queens  */ 0x0000000008000000, /* white king    */
            0x0000000000080000,
            /* black pawns    */ 0x0022000000000000, /* black knights */ 0x0000000000000000, /* black bishops */
            0x0000000000000000,
            /* black rooks    */ 0x0000000200000000, /* black queens  */ 0x0008000000000000, /* black king    */
            0x0000000000000000,
        ...
        */
        Kangaroo::Chess_Board(std::array<Bitboard, 15>{
            /* white pawns    */ 0x0000000000220000, /* white knights */ 0x0000000000000000, /* white bishops */
            0x0000000000000000,
            /* white rooks    */ 0x0000002000000000, /* white queens  */ 0x0000080000000000, /* white king    */
            0x0000000000080000,
            /* black pawns    */ 0x0022000000000000, /* black knights */ 0x0000000000000000, /* black bishops */
            0x0000000000000000,
            /* black rooks    */ 0x0000000200000000, /* black queens  */ 0x0008000000000000, /* black king    */
        ...
        */
        Kangaroo::Chess_Board(std::array<Bitboard, 15>{
            /* white pawns    */ 0x0000000000220000, /* white knights */ 0x0000000000000000, /* white bishops */
            0x0000000000000000,
            /* white rooks    */ 0x0000002000000000, /* white queens  */ 0x0008000000000000, /* white king    */
            0x0000000000080000,
            /* black pawns    */ 0x0022000000000000, /* black knights */ 0x0000000000000000, /* black bishops */
            0x0000000000000000,
            /* black rooks    */ 0x0000000200000000, /* black queens  */ 0x0000000000000000, /* black king    */
            0x0000000000000000,
            /* en passant sq. */ 0x0000000000000000, /* half move num */ 0x0000000000000000, /* full move num */
            0x0000000000000001
        }),
 ...
 /*
   ...
   1    .  .  .  .  .  .  .  .
     ...
     */
    TEST(Queen_Move_Generation, Pin_HV) {
        ...
        Chess_Board board{};
        const auto status = board.reset_board("8/1p1q1p2/8/1r1Q1R2/8/1P1K1P2/8/8 w KQkq - 0 1 ");
