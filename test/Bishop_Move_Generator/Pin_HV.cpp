...
namespace Kangaroo::Bishop_Move_Generation::Pin_HV {
...
*/
  Kangaroo::Chess_Board( std::array<Bitboard, 15>{
    ...
    /* white rooks    */ 0x0000000000000000, /* white queens  */ 0x0000000000000000, /* white king    */ 0x0000000000004000,
    /* black pawns    */ 0x0000000000000000, /* black knights */ 0x0000000000000000, /* black bishops */ 0x0000000000000000,
    /* black rooks    */ 0x0000000000000000, /* black queens  */ 0x0002000000000000, /* black king    */ 0x0000000000000000,
...
*/
  ...
  1    .  .  .  .  .  .  .  .
     ...
     */
    TEST(Bishop_Move_Generation, Pin_HV) {
        ...
        Chess_Board board{};
        const auto status = board.reset_board("8/8/8/q2B3K/8/8/8/8 w KQkq - 0 1 ");
