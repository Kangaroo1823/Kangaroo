...
macro(Kangaroo_setup_options)
    ...
    if(NOT PROJECT_IS_TOP_LEVEL OR Kangaroo_PACKAGING_MAINTAINER_MODE)
        ...
        option(Kangaroo_ENABLE_INCLUDE_WHAT_YOU_USE_ "Enable include-what-you-use" ON)
        ...
        option(Kangaroo_ENABLE_SANITIZER_THREAD "Enable thread sanitizer" ON)
        option(Kangaroo_ENABLE_SANITIZER_MEMORY "Enable memory sanitizer" ON)
        option(Kangaroo_ENABLE_UNITY_BUILD "Enable unity builds" ON)
        option(Kangaroo_ENABLE_CLANG_TIDY "Enable clang-tidy" OFF)
...
#
    ...
    if(Kangaroo_ENABLE_INCLUDE_WHAT_YOU_USE_)
        Kangaroo_enable_include_what_you_use()
    endif ()
